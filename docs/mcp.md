...
Rust MCP server for this product: **stdio** or **Streamable HTTP** on port **8790**.
...
Cursor: `"url": "http://127.0.0.1:8790/mcp"`.
...
casper-nctl-2-docker-mcp --http                  # 0.0.0.0:8790
casper-nctl-2-docker-mcp --http --listen 127.0.0.1:8790
```
